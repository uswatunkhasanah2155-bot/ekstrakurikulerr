...
export default function Sidebar({ isAdmin }) {
  ...
  const namaEskulDibina = daftarEskulSidebar[0]?.nama_eskul;
      ...
      <div>
        ...
        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl mb-6 border border-gray-100">
          ...
          <div>
            ...
            <span
              className={`text-[11px] px-2 py-0.5 rounded-full font-semibold ${roleBadgeClass}`}
            >
              {roleLabel}
            </span>
          </div>
        ...
        <nav className="space-y-1">
          ...
          {isAdmin && (
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold text-cyan-700 bg-cyan-50 hover:bg-cyan-100 transition-colors mt-1"
            >
          ...
          {isAdmin && (
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold text-orange-700 bg-orange-50 hover:bg-orange-100 transition-colors mt-1"
            >
          ...
          <div className="mt-1">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span>
                  {isPembina ? 'Eskul yang Dibina' : 'Daftar Eskul'}
                </span>
              </div>
