...
export default function PendaftarEskul() {
    ...
    async function fetchData() {
      ...
      try {
        ...
        result.forEach((item) => {
          ...
          // Mengambil nama kelas dari relasi kelasData
          const kelasSiswa =
            item.siswa?.kelasData?.nama_kelas || 'Belum diisi';

          const groupKey = `${namaSiswa.trim().toLowerCase()}|${kelasSiswa
            .trim()
            .toLowerCase()}`;
          ...
          if (
            tanggalItem > grouped[groupKey].tanggalTerbaru
          ) {
  ...
  const filteredPendaftar = dataPendaftar.filter(
    (pendaftar) => {
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Daftar seluruh siswa yang telah mendaftarkan diri
